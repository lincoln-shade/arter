...
Brain arteriolosclerosis (B-ASC) is a small-vessel cerebrovascular disease characterized by pathologically altered arterioles associated with cognitive impairment. The genetics of other contributors of dementia have been studied extensively, but to date no in-depth study has been conducted on genetic risk of autopsy-proven B-ASC. We performed a genome-wide association study (GWAS) on B-ASC using multiple aged neuropathologic cohorts. Included in the study were participants with autopsy B-ASC endophenotype and genotype data available from NACC, ROSMAP, ADNI, and ACT data sets. Initial Stage 1 GWAS (*n* = `r nacc[, .N]`) and Stage 2 mega-analysis (*n* = `r nacc_rosmap[, .N]`) were performed using data from the two largest cohorts (NACC and ROSMAP). Replication of top variants and additional Stage 3 mega-analysis were performed incorporating two smaller cohorts: (ADNI and ACT). Lead variants in the top two loci in the Stage 1 mega-analysis (rs7902929, *p* = `r nacc_rosmap_results[SNP == "rs7902929", nice_p(P)]` ; rs2603462, *p =* `r nacc_rosmap_results[SNP == "rs2603462", nice_p(P)]`) replicated in the first replication cohort (rs7902929, *p* = `r adni_replication_top[SNP == "rs7902929", signif(P, 2)]`; rs2603462, *p =* `r adni_replication_top[SNP == "rs2603462", signif(P, 2)]`). The rs2603462 lead variant colocalizes with *ELOVL4* expression in the cerebellum (posterior probability = 92.9%). Suggestive results were also found for putative B-ASC risk associated variants in *SORCS1* and *SORCS3*. We thus identified putative loci associated with B-ASC risk but additional replication is required
...
Additionally, a member of the VPS10 family, *SORCS1*, achieved the smallest *p*-value in the gene-based analysis. We performed a *post-hoc* analysis of this region and identified two independent loci with lead *p*-values just above our suggestive threshold driving this effect: one locus in LD with rs7902929 and one not (*p* = 1.2x10^-5^). We examined the lead variant in the second locus and identified a consistent effect across all four cohorts that was nominally significant in NACC (*p* = 1x10^-4^) and ACT (*p* = 0.001), though not in ROSMAP (*p* = 0.25) or ADNI (*p* = 0.07). Previous studies have identified *SORCS1* as a potential risk variant for AD [@reitz2013; @wang2020]. Therefore, it is possible that the VPS10 family influences B-ASC risk through AD risk, or vice versa, though further work should be done to clarify the possible role of the VPS10 family on both phenotypes.

Statistical modeling indicated that none of the effects of top loci in the NACC GWAS appeared to be mediated by HTN or DM status in NACC. This finding has some caveats, including the inconsistent evidence of association between these clinical risk factors and B-ASC pathology [@ighodaro2017; @blevins2021]. However, this analysis was limited by the substantially smaller sample size (*n* = `r nrow(nacc_htn)`) than that of the NACC GWAS. Additionally, the diagnostic variables in NACC consisted of a mixture of patient self-reports, physician reporting, and use of HTN or DM medications. Future studies employing causal inference methods such as two-sample Mendelian randomization may be able to provide clearer evidence for or against the roles of HTN and DM in B-ASC and the mediation of B-ASC genetic risk by clinical risk factors.

The most obvious limitation of our study is the relatively low sample size for a GWAS. NACC, the largest cohort used, had only `r nacc[, .N]` participants available for GWAS, and the total sample size of the Stage 3 mega-analysis with all four cohorts was `r act_mega[, .N]`. In contrast, a recent GWAS meta-analysis of AD exceed 90,000 participants @kunkle2019, and GWAS of other phenotypes have exceeded 1 million participants @lee2018. Nevertheless, smaller GWAS of other neuropathologic endophenotypes have identified risk loci [@katsumata2017], demonstrating that smaller sample sizes do not necessarily prevent discovery.

Despite sample size limitations, one suggestive locus on Chromosome 10 near *SORCS3* identified in NACC was validated in ROSMAP, and both this locus and a locus near *ELOVL4* were replicated in ADNI. Furthermore, 11 of 13 B-ASC-associated loci in NACC had affect sizes in the same direction in ROSMAP, which suggests that these loci may be associated with B-ASC but suffer from the "winner's curse" in the NACC analyses. Furthermore, the use of downstream analyses can provide additional functional evidence for risk loci that do not meet the conservative Bonferroni-corrected significance thresholds.

Most genetic loci identified preliminarily as being associated with B-ASC in NACC were not validated in ROSMAP. This could be potentially explained via the significantly different demographic attributes and study designs between the two cohorts, as ROSMAP participants were older at death and had lower levels of diagnosed B-ASC pathology (**Table 1**). Thus, there may be unaccounted-for confounding and differential selection bias between cohorts. For instance, ROS recruits from Catholic sisters and brothers, who are on average more highly educated than the general population. In contrast, the NACC participants are recruited from diverse (primarily clinic-based) populations across the ADRCs. Differences in study design are also seen in the ADNI cohort, whose recruitment practices resemble those of ADRCs, and in ACT, whose participants are recruited from the aged dementia-free community in the Seattle, WA area.

Heterogeneity in neuropathological grading of B-ASC in each cohort may also contribute to impairing study power and limiting reproducibility between studies. In one study investigating the inter-rater reliability of cerebrovascular neuropathological endophenotypes, B-ASC had the second-lowest reliability (after microinfarcts), with reliability below 0.8 in five of twelve brain regions graded [@skrobot2016]. This relatively low inter-rater diagnostic reliability under near-ideal circumstances (*i.e.* looking at the exact same stained slides) indicates there may be substantial measurement variance in B-ASC between neuropathologists both within and between study centers. Furthermore, B-ASC is likely graded in different brain regions in different centers and studies. B-ASC is graded globally in NACC, with no particular brain region specified, but is graded based on findings in the basal ganglia in ROSMAP @chou2013. Documentation on the brain regions graded for B-ASC in ADNI and ACT is limited.
