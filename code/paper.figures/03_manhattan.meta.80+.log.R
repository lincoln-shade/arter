...
results <- fread("../NACC.ROSMAP.meta/02_analysis/ordinal.meta")

top.snps <- fread("../NACC.ROSMAP.meta/02_analysis/ordinal.top.indep.snps.txt", header = F) %>% 
  .[, V1]
...
ggsave("tabs.figs/meta.80+.ord.manhattan.png", manplot, units = "in", width = 12, height = 6)
