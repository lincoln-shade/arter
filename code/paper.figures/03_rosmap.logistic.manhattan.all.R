...
results <- fread("../ROSMAP/all/02_analysis/logistic/regression.assoc.logistic")

top.snps <- fread("../ROSMAP/all/02_analysis/logistic/plink.clumped")
...
ggsave("tabs.figs/rosmap.manhattan.logistic.all.png", manplot, units = "in", width = 12, height = 6)
