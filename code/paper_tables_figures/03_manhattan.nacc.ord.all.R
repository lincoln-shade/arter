...
results <- fread("../ADGC.HRC/65+/02_analysis/ordinal/nacc.results.csv")


top.snps <- fread("../ADGC.HRC/65+/02_analysis/ordinal/plink.clumped")
...
ggsave("tabs.figs/nacc.65+.ord.manhattan.png", manplot, units = "in", width = 12, height = 6)
