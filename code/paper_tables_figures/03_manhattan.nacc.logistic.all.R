...
results <- fread("../ADGC.HRC/65+/02_analysis/logistic/regression.assoc.logistic")


top.snps <- fread("../ADGC.HRC/65+/02_analysis/logistic/plink.clumped")
...
ggsave("tabs.figs/nacc.65+.logistic.manhattan.png", manplot, units = "in", width = 12, height = 6)
