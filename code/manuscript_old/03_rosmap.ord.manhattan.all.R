...
results <- fread("../ROSMAP/all/02_analysis/ordinal/rosmap.results.csv")

top.snps <- fread("../ROSMAP/all/02_analysis/ordinal/plink.clumped")
...
ggsave("tabs.figs/rosmap.ord.manhattan.all.png", manplot, units = "in", width = 12, height = 6)
