...
ggsave(filename = "output/nacc_adgc/nacc_rosmap_1000g_pca_related.png", pca.plot2, units="in", width=7, height=7)

write.table(nacc.ids, "data/nacc_adgc/nacc_adgc_related_qced.txt", col.names = F, row.names = F, quote = F)
